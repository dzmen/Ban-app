...
;
    ...
    $.fn.pwi.defaults = {
        ...
        username: 'banwebcie', //-- Must be explicitly set!!!
        ...
        labels: {
            photo: "foto",
            photos: "foto's",
            downloadphotos: "Download foto",
            albums: "Terug naar albums",
            noalbums: "Geen albums beschikbaar",
            page: "Pagina",
            prev: "Vorige",
            next: "Volgende",
        ...
        popupPlugin: "fancybox", // If empty the name will be determined automatically
